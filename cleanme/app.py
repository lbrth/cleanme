...
def main():
	...
	parser = argparse.ArgumentParser(description=" Python script to clean video folder : Deduplication - TV Series are sort by name and season - Films are sort inside unique folder")
